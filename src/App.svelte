<script lang="ts">
	import AuthorComponent from './AuthorComponent.svelte';
  import Splitter from './Splitter.svelte';
import SubscriberComponent from './SubscriberComponent.svelte';

  export let name: string;

  import * as streams from "./web/iota_streams_wasm.js";

  // new URL('iota_streams_wasm_bg.wasm', import.meta.url);

  streams.default("/web/iota_streams_wasm_bg.wasm").then((s) => {
...
<main>
  ...
  <button on:click={test}>OK</button>
</main>
...
<Splitter>
  <div slot="left">
    <AuthorComponent {streams}></AuthorComponent>
  </div>
  <div slot="right">
    <SubscriberComponent {streams}></SubscriberComponent>
  </div>
</Splitter>
