...
export function userstate_get_identifier(a: number, b: number): void;
export function userstate_get_link(a: number): number;
export function userstate_get_seq_no(a: number): number;
export function userstate_get_branch_no(a: number): number;
...
export function nextmsgid_get_identifier(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h801e58843c6e16dd(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function wasm_bindgen__convert__closures__invoke2_mut__h85ebf086f28a5177(a: number, b: number, c: number, d: number): void;
